// As we have seen in previous codes the problem is we are dealing with errors but there are no standards means somewhere we are sending status code somewhere not, somewhere we are sending json somewhere not.
// So to standardize error response we will use nodejs "Error" class and override it's some of the methods.
